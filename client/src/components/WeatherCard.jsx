...
const getCardStyle = (description) => {
    ...
    if (desc.includes('mist') || desc.includes('haze')){
    ...
    const WeatherCard = ({cityData}) => {
        ...
        if(!Weather || Object.keys(Weather).lenght === 0){
            retrun (
        ...
        return (
            <div className={`weather-card bg-gradient-to-br ${backgroundClass} rounded-lg p-6 shadow-lg flexflex-col justify-between min-h-[380px] transition-transform duration-200 hover:scale-105`}>
                ...
                <div className="card-main-info flex-grow flex-col justify-center py-5">
                    <div className="flex items-center">
                        <span className="weather-icon text-5xl mr-4"></span>
                ...
                <div className="detail-row flex justify-between mt-2">
                    ...
                    <div className="sun-times text-right">
                        <p>Sunrise: {formtTime(sys.sunrise)}</p>
