...
const { isAuthenticated, isLoading } = useAuth0();
  ...
  if (isLoading) {
    return <div className="text-center p-20 text-xl">Loading authentication state...</div>;
  }
     ...
     <AuthButtons />
      ...
      {isAuthenticated ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen -mt-20">
          ...
          <p className="text-xl text-gray-400">Please log in to access the weather dashboard.</p>
        </div>
      )}
    </div>
  )
